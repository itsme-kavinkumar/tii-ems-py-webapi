...
async def load_analysis(company_id : int = Form(""),
    ...
    try: 
        ...
        data = await load_analysis_mdl(cnx,company_id,bu_id,plant_id,period_id,group_by,equipment_id,meter_id,from_date,to_date,shift_id,from_time,to_time,duration,meter_status, detail_view)
