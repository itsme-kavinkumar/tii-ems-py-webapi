...
async def meter_list(company_id : int = Form(''),
                     ...
                     ip_address: str = Form(""),
                     source: str = Form(""),
                     is_main_transformer_meter: str = Form(""),
                     cnx: AsyncSession = Depends(get_db)): 
    try: 
        createFolder("Log/","query:"+str(meter_id))
        result = await meter_Lists(cnx, company_id,bu_id,meter_id,type_value,type_id,is_critical,model_name,plant_id,plant_department_id,function_id,function2_id,holiday,selected,campus_id,meter,equipment_id,equipment_group_id,meter_type,selected_meter,ip_address,source,is_main_transformer_meter)
        where = ''
...
async def save_meter_details(company_id: int = Form(''),
    ...
    try:
        ...
        if meter_id == "":
            ...
            await save_meter(cnx, company_id,bu_id,plant_id,plant_department_id,campus_id,function_id,converter_id,meter_id,meter_code,meter_name,other_equipment_name,ip_address,port,major_nonmajor,model_name,IMEI,user_login_id,function2_id,address,parameter, sub_parameter,meter_type,source,physical_location,max_demand,max_pf,main_demand_meter,consumption_type,is_poll_meter,meter,equipment_group_id,equipment_id,mac)
            ...
            await update_meter(cnx, company_id,bu_id,plant_id,plant_department_id,campus_id,function_id,converter_id,meter_id,meter_code,meter_name,other_equipment_name,ip_address,port,major_nonmajor,model_name,IMEI,user_login_id,function2_id,address,parameter, sub_parameter,meter_type,source,physical_location,max_demand,max_pf,main_demand_meter,consumption_type,is_poll_meter,meter,equipment_group_id,equipment_id,mac)
