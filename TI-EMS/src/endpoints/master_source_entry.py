...
async def savesourceentry(id: int = Form(""),                                
                          ...
                          updated_energy_source_name:str= Form(""),
    ...
    try:
        ...
        if id == '':
            ...
            await update_source_entry(cnx, id,campus_id,period_type,energy_source_name,user_login_id,source_type,updated_energy_source_name)
...
async def save_src_entry_data(campus_id :str = Form(""),
    ...
    try:
        ...
        response = await save_source_entry_data(cnx, obj,obj2,mill_date_month,campus_id,mill_date,user_login_id)
        if response:
            return _getSuccessResponseJson("Saved Successfully...")  
        else :
            return _getErrorResponseJson("Monthly consumption cannot be grater than EB consumption") 
