...
async def save_converter(cnx,campus_id,converter_model_id,converter_name,ip_address,port_no,meter_limit,user_login_id,mac,company_id,bu_id,plant_id,baud_rate,parity,is_communication_check):

    query = text(f"""
            INSERT INTO ems_v1.master_converter_detail (
                 converter_name, ip_address, port_no, created_on, created_by,meter_limit,campus_id,converter_model_id,mac,company_id,bu_id,plant_id,baud_rate,parity,is_communication_check
            )
            VALUES (
                ...
                ,'{baud_rate}','{parity}','{is_communication_check}'
            )
        """) 
...
async def update_converter(cnx,campus_id,converter_model_id,converter_id,converter_name,ip_address,port_no,meter_limit,user_login_id,mac,company_id,bu_id,plant_id,baud_rate,parity,is_communication_check):
    ...
    query =text(f"""
            ...
            is_communication_check = '{is_communication_check}'
